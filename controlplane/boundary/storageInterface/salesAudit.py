...
def _llm_match_service(
    ...
    prompt = (
        ...
        "3. Treat any candidate that combines two or more distinct activities (e.g., 'Horse Ride Agafay', "
        "'Hammam + Massage', 'Quad + Dinner') as a COMBO. Only match the input to a combo if the input "
        "explicitly mentions all the component activities.\n"
        ...
        "'Horse Ride Agafay' is a combo (horse riding + Agafay experience) — input only says 'agafay' "
        "so it must not be matched to a combo. The standalone Agafay packs are ambiguous among themselves.\n"
        "- Input='horse ride agafay', candidates include 'Agafay pack 1', 'Horse Ride Agafay': "
        "return matched='Horse Ride Agafay'. Input explicitly mentions both activities.\n"
